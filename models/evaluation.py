...
from prompt.prompt_collection import IN_CONTEXT_EXAMPLES, INSTRUCTIONS
from tqdm.auto import tqdm
from transformers import LlamaTokenizerFast


os.environ["OPENAI_API_KEY"] = openai_key
tokenizer = LlamaTokenizerFast.from_pretrained("meta-llama/Llama-3.1-70B", cache_dir="/ceph/mboeckli/KGRag/models/huggingface/")
...
def evaluate_predictions(queries, ground_truths, predictions, evaluation_model_name, openai_client):
    ...
    for _idx, prediction in enumerate(tqdm(
        ...
        if "I do not know the answer" in prediction_lowercase:
            n_miss += 1
            continue
...
if __name__ == "__main__":
    ...
    DATASET_PATH = "data/CRAG/dataset/crag_task_1_dev_v4_release.jsonl.bz2"
